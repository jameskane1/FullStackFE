...
var submitValues = __webpack_require__(12);
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createSignIn(data).then(ui.signInSuccess).then(ui.removeClass).then(ui.addClass).then(function () {
    $('#signInForm')[0].reset();
...
var onSignOut = function onSignOut(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signOut(data).then(ui.signOutSuccess).then(ui.signOutClass).then(function () {
    ...
    $('#play_result').empty();
  }).then(ui.changePWClass).catch(ui.signOutFailure);
};
...
var onPlayInput = function onPlayInput(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.playInput(data).then(ui.playInputSuccess).then(onPlayShow).then(function () {
    $('#playInput')[0].reset();
  }).then(function () {
    $('#previousPlaysMessage').empty();
  }).then(function () {
...
var onPlayShow = function onPlayShow() {
  api.playData().then(ui.playShowSuccess).catch(ui.playShowSuccess);
};

var onPreviousPlayShow = function onPreviousPlayShow(event) {
  event.preventDefault();
  api.playData().then(ui.previousPlaysSuccess).then(function () {
    $('#previousPlays').addClass('signOut');
  }).catch(ui.previousPlaysFailure);
};

var onDeletePlay = function onDeletePlay(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.deletePlay(data).then(ui.deletePlaySuccess).then(function () {
    $('#delete_play')[0].reset();
  }).then(function () {
    $('#previousPlaysMessage').empty();
  }).then(function () {
...
var onUpdatePlay = function onUpdatePlay(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.updatePlay(data).then(ui.updatePlaySuccess).then(function () {
    $('#updatePlay')[0].reset();
  }).then(function () {
    $('#previousPlaysMessage').empty();
  }).then(function () {
...
var onGet1Play = function onGet1Play(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.get1Play(data).then(ui.get1PlaySuccess).then(function () {
    $('#get1Play')[0].reset();
  }).then(function () {
    $('#lastPlay').empty();
  }).then(function () {
  ...
  }).then(ui.updateClass).then(ui.get1PlayShow).catch(ui.get1PlayFailure);
};
...
exports.onPlayInput = onPlayInput;
exports.onPlayShow = onPlayShow;
exports.onPreviousPlayShow = onPreviousPlayShow;
exports.onDeletePlay = onDeletePlay;
exports.onUpdatePlay = onUpdatePlay;
exports.onGet1Play = onGet1Play;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var playInput = function playInput(data) {
  return $.ajax({
...
var playData = function playData() {
  return $.ajax({
    url: config.apiOrigin + '/plays',
    method: 'GET',
    headers: {
...
var deletePlay = function deletePlay(data) {
  return $.ajax({
...
var get1Play = function get1Play(data) {
  return $.ajax({
    url: config.apiOrigin + '/plays/' + data.play.id,
    method: 'GET',
    headers: {
...
var updatePlay = function updatePlay(data) {
  return $.ajax({
...
var store = __webpack_require__(5);
var showPlaysTemplate = __webpack_require__(16);
...
var signOutClass = function signOutClass() {
...
var changePWClass = function changePWClass() {
...
var playInputSuccess = function playInputSuccess(data) {
...
var playInputFailure = function playInputFailure(error) {
  $('#message').text('Your play could not be added', error);
};

var playShowFailure = function playShowFailure(error) {
  $('#plays').text('Could not find any plays', error);
};

var get1PlayShow = function get1PlayShow(data) {
...
var previousPlaysSuccess = function previousPlaysSuccess(data) {
  if (data.plays[0] === null || data.plays[0] === '' || data.plays[0] === undefined || data.plays[0] === 0 || data.plays[0] === false) {
    ...
    var showPlaysHtml = showPlaysTemplate({ plays: data.plays });
    $('#previousPlaysMessage').append(showPlaysHtml);
  }
};

var previousPlaysFailure = function previousPlaysFailure(error) {
  $('#message').text('Your plays cannot be viewed', error);
};

var deletePlaySuccess = function deletePlaySuccess(data) {
...
var deletePlayFailure = function deletePlayFailure(error) {
  $('#message').text('The entered id does not exist, or you do not have any saved plays', error);
};

var updatePlaySuccess = function updatePlaySuccess(data) {
...
var updatePlayFailure = function updatePlayFailure(error) {
  $('#message').text('Your plays cannot be updated at this time', error);
};

var get1PlaySuccess = function get1PlaySuccess(data) {
  $('#message').text('Your input play has been selected to be edited');
  store.play1 = data.play;
  $('#message').prepend('<img id="theImg" img class="tommytd" src="https://pbs.twimg.com/media/BuHyfTVCIAAVbkG.jpg" />');
};

var get1PlayFailure = function get1PlayFailure(error) {
...
exports.signOutClass = signOutClass;
exports.changePasswordSuccess = changePasswordSuccess;
exports.changePasswordFailure = changePasswordFailure;
exports.playInputSuccess = playInputSuccess;
exports.playInputFailure = playInputFailure;
exports.playShowFailure = playShowFailure;
exports.previousPlaysSuccess = previousPlaysSuccess;
exports.previousPlaysFailure = previousPlaysFailure;
exports.deletePlaySuccess = deletePlaySuccess;
exports.deletePlayFailure = deletePlayFailure;
exports.updatePlaySuccess = updatePlaySuccess;
exports.updatePlayFailure = updatePlayFailure;
exports.get1PlaySuccess = get1PlaySuccess;
exports.get1PlayFailure = get1PlayFailure;
exports.updateClass = updateClass;
exports.changePWClass = changePWClass;
exports.get1PlayShow = get1PlayShow;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n<div class=\"col-xs-8 col-md-8 minibox\">\n  <h1 data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\n  </div>\n    <li><div>\n      Yard Line : "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.yard_line : stack1), depth0))
    + "\n  </div>\n  <li><div>\n      Play Type: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.play_type : stack1), depth0))
    + "\n</div>\n<li><div>\n      Yards Gained: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.yards_gained : stack1), depth0))
    + "\n</div>\n<li><div>\n      Play Result: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.play_result : stack1), depth0))
    + "\n</div>\n</ul>\n\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.plays : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
